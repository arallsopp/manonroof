...
const ExerciseData = (() => {
    ...
    const IMAGE_MAP = {
        pushups:           ['images/pushups.jpg'],
        shoulder_taps:     ['images/shoulder_taps.jpg'],
        commandos:         ['images/commandos.jpg'],
        lat_pull_pushup:   ['images/lat_pull_pushup_1.jpg', 'images/lat_pull_pushup_2.jpg', 'images/lat_pull_pushup_3.jpg'],
        plank_toe_touches: ['images/plank_toe_touches.jpg'],
        calf_hops:         ['images/calf_hops.jpg'],
        crunch_pause:      ['images/crunch_pause.jpg'],
        oblique_r:         ['images/oblique_r.jpg'],
        oblique_l:         ['images/oblique_l.jpg'],
        twisting_tabletop: ['images/twisting_tabletop.jpg'],
